		...
		while ( have_posts() ) {
			...
			echo '<section class="each-posting "> 
					<a class="post-title" href="';
							the_permalink();
			echo 	'">
					<div class="post-thumb columns large-4 medium-4 small-12 nopadding">';
					if ( has_post_thumbnail() ):  
						echo '<div id="latest-post-thumb">'; 
							the_post_thumbnail('', array('class' => 'th'));  
						echo '<div class="clearfix">&nbsp;</div> 
							  </div>
					</div>';
					endif;
			echo '	<div class="post-content columns large-8 medium-8 small-12">';
